...
public class Flight implements iFly, iTransferFlight, iPlaneState {
    ...
    public Flight(Plane<Seat> plane, Airport<Airline<Flight>> originAirport, Airport<Airline<Flight>> destinationAirport,LocalDate date, LocalTime departureTime, LocalTime arrivalTime) {
        this.plane = plane;
